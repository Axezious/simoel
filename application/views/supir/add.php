           ...
           <?php echo form_open_multipart('supir/add'); ?>
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="namaDriver" id="namaDriver" class="form-control" placeholder="Nama Driver" value="<?php echo set_value('namaDriver'); ?>">
                </div>
              <!-- <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="ktp" id="ktp" class="form-control" placeholder="No. KTP" value="<?php echo set_value('ktp'); ?>">
                </div>
                <div class="form-group">
