           ...
           <?php echo form_open_multipart('mobil/add'); ?>
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="namaKendaraan" id="namaKendaraan" class="form-control" placeholder="Nama Kendaraan" value="<?php echo set_value('namaKendaraan'); ?>">
                </div>
                <div class="form-group">
                <label>Merk Kendaraan</label>
                <input type="text" name="merkKendaraan" id="merkKendaraan" class="form-control" placeholder="Merk Kendaraan" value="<?php echo set_value('merkKendaraan'); ?>">
              </div>
              <div class="form-group">
                  ...
                  value="<?php echo set_value('bahanBakar'); ?>">
                </div>
              <div class="form-group">
                  <label for="merk">No. Plat Kendaraan</label>
                  <input type="text" name="platKendaraan" id="platKendaraan" class="form-control" placeholder="No. Plat Kendaraann" value="<?php echo set_value('platKendaraan'); ?>">
                </div>
                <div class="form-group">
