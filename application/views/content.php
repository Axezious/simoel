                ...
                <div class="box-body no-padding">
                  ...
                  ?>  
                      <li>
                        ...
                        <a class="users-list-name" href="#"><?php echo $row->namaKendaraan; ?></a>
                        <p><?php echo $row->platKendaraan; ?></p>
                        <span class="users-list-date"><?php echo ucfirst($row->merkKendaraan); ?></span>
                      </li>
                  <?php } ?>
